...
const ImageBrowser: React.FC<ImageBrowserProps> = ({
  ...
  const handlePreviewSelectedImage = useCallback(() => {
    if (selectedImageIndex >= 0 && selectedImageIndex < sortedImages.length) {
  ...
  }, [selectedImageIndex, sortedImages, currentView]);
    ...
    setTimeout(() => {
      ...
      if (selectedElement) {
        ...
        const scrollContainer =
          selectedElement.closest('.h-full.overflow-y-auto') ||
        ...
        if (scrollContainer) {
          ...
          const scrollDistance =
            containerScrollTop +
            elementCenterRelativeToContainer -
            containerCenter;
  ...
  useEffect(() => {
    const shortcuts = [
      ...
      },
      {
        ...
        description: t('keyboard.shortcuts.selectLeft'),
      ...
      },
      {
        ...
        description: t('keyboard.shortcuts.openSelected'),
  ...
  }, [sortedImages.length, scrollToSelectedItem]);
  ...
  useEffect(() => {
    if (selectedImageIndex >= 0 && sortedImages.length > 0) {
