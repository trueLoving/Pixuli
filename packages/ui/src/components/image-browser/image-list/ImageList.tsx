        ...
        <div className="px-6 py-4">
          <div className="image-list-main-row">
            <div className="image-list-thumbnail-container">
              ...
              {/* 选中指示器 */}
              {isSelected && (
                <div className="image-list-selected-badge">
                  ✓
                </div>
              )}
            </div>
            ...
            <div className="image-list-main-content">
              <div className="image-list-info-row">
                <h3 className={`image-list-title ${isSelected ? 'selected' : 'unselected'}`}>
                  {image.name}
                  {isSelected && <span className="image-list-selected-indicator">{translate('image.list.selected')}</span>}
                </h3>
                {image.tags.length > 0 && (
    ...
    return (
      <div className="image-list-empty">
        <div className="image-list-empty-content">
          ...
          <h3 className="image-list-empty-title">{translate('image.list.emptyTitle')}</h3>
          <p className="image-list-empty-description">{translate('image.list.emptyDescription')}</p>
        </div>
      </div>
    )
  }
