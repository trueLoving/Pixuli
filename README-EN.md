...
Want to learn more about development details? Check out the development
documentation for each platform:

- **[Desktop Development Guide](./apps/desktop/CONTRIBUTING.md)** - Desktop
  environment setup, development workflow, project structure
- **[Web Development Guide](./apps/web/CONTRIBUTING.md)** - Web environment
  setup, development workflow, project structure
- **[Mobile Development Guide](./apps/mobile/CONTRIBUTING.md)** - Mobile
  environment setup, development workflow, project structure
...
| **Development Docs** | [Desktop Development Guide](./apps/desktop/CONTRIBUTING.md) | Desktop development guide  |
|                      | [Web Development Guide](./apps/web/CONTRIBUTING.md)         | Web development guide      |
|                      | [Mobile Development Guide](./apps/mobile/CONTRIBUTING.md)   | Mobile development guide   |
| **Roadmap**          | [Desktop Roadmap](./apps/desktop/ROADMAP.md)                | Desktop feature planning   |
|                      | [Web Roadmap](./apps/web/ROADMAP.md)                        | Web feature planning       |
|                      | [Mobile Roadmap](./apps/mobile/ROADMAP.md)                  | Mobile feature planning    |
| **Changelog**        | [Desktop Changelog](./apps/desktop/CHANGELOG.md)            | Desktop version history    |
|                      | [Web Changelog](./apps/web/CHANGELOG.md)                    | Web version history        |
|                      | [Mobile Changelog](./apps/mobile/CHANGELOG.md)              | Mobile version history     |
