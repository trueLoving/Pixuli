export const mobileLocales = {
  'zh-CN': {
    ...
    settings: {
      ...
      operationLog: {
        ...
        exportFailed: '导出失败',
        confirmClear: '确认清理',
        confirmClearMessage: '确定要清理日志吗？此操作不可恢复。',
        clearSuccess: '清理成功',
      },
      shortcuts: {
        title: '快捷键',
    ...
    image: {
      ...
      imageName: '图片名称',
      fileName: '文件名',
      fileNamePlaceholder: '请输入文件名（不含扩展名）',
      renameImage: '重命名图片',
      dimensions: '尺寸',
      description: '描述',
  ...
  'en-US': {
    ...
    settings: {
      ...
      operationLog: {
        title: 'Operation Log',
        description: 'View and export operation logs',
        total: 'Total',
        today: 'Today',
