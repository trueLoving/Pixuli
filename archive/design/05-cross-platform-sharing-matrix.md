...
> [01-system-design.md](../../docs/02-system-design/01-system-design.md) · 索引
> [README.md](./README.md)
...
- **相关文档**：
  ...
  - PRD
    [§4.3 平台能力矩阵](../../docs/01-product/01-product-requirements-specification.md#43-平台能力矩阵)
    — 产品向 L3 能力（REF-501 / #86）

> **说明**：Issue #116 初稿曾引用
> `06-unified-app-mobile-integration.md`；该编号已用于
> [03-plugin-host-integration.md](./03-plugin-host-integration.md)（REF-411）。**Mobile 融入
...
| --------------- | ------------------------------------- | --------------------------------- | -------------------------- | -------------------------------------------------------------------- |
| **imageStore**  | `src/stores/imageStore.ts` (~618 行)  | `stores/imageStore.ts` (~1007 行) | **重复** · RN 归档前不对齐 | Capacitor 用 pixuli；见 [#164](./06-mobile-feature-parity-matrix.md) |
...
✅ → **#118** ✅ → **[#164](./06-mobile-feature-parity-matrix.md)** 对齐矩阵 →
**品牌资源** ✅ → **#150** → **#165** 业务补齐 → **#119/#120/#141** → **#166**
验收 → **#152/#153** → **#151** 归档 RN。

| 后续 Issue           | 标题                                  | 依赖本矩阵章节                                                                                       |
| -------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| **#164** REF-516 P0  | RN ↔ pixuli 功能对齐矩阵（用户旅程） | 全文见 [06-mobile-feature-parity-matrix.md](./06-mobile-feature-parity-matrix.md)                    |
| ~~**#117** REF-507~~ | ~~抽取 store~~                        | **❌ 取消** — Capacitor 单工程三端                                                                   |
| **#119** REF-508     | `@pixuli/ui` L1/L2 native 迁入评估    | [07-ui-native-migration-assessment.md](./07-ui-native-migration-assessment.md) 全文                  |
| **#118** REF-509     | Capacitor Android PoC（工程 ✅）      | [04-capacitor-android-poc.md](./04-capacitor-android-poc.md)                                         |
...
| **#130** REF-601     | 三端融合交互设计                      | [04-three-platform-interaction-spec.md](../../docs/01-product/04-three-platform-interaction-spec.md) |
...
> [06-mobile-feature-parity-matrix.md §五](./06-mobile-feature-parity-matrix.md#五165ref-516-p3-业务补齐输入清单)（#165）。
...
[06-mobile-feature-parity-matrix.md §八](./06-mobile-feature-parity-matrix.md#八与-prd-43--ref-501-交叉索引)
...
- [06-mobile-feature-parity-matrix.md](./06-mobile-feature-parity-matrix.md)（旅程与 L3 决策 ·
  REF-516 P0 / [#164](https://github.com/trueLoving/Pixuli/issues/164)）
- [07-ui-native-migration-assessment.md](./07-ui-native-migration-assessment.md)（**#119**
  L2 组件与 `./native` 评估）
...
- [x] 链到 [02-three-platform-design.md](./02-three-platform-design.md)（方案 A
      / 过渡 C）
- [x] 写入 `archive/design/05-cross-platform-sharing-matrix.md`
