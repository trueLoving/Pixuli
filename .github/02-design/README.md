...
| 序号 | 文档                                                                                                       | 主题概要                | 关键内容                                                                                                                                                 |
| ---- | ---------------------------------------------------------------------------------------------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 00   | [00-System-Design.md](./00-System-Design.md)                                                               | 整体系统设计            | 系统概述、架构图、模块与职责、数据流与存储、技术栈、部署形态、与 PRD/设计文档/CI/CD 的衔接                                                               |
...
- **目标**：建立系统全貌说明，统一对边界、模块、数据流与部署形态的认知。
- **要点**：方案概述与设计原则、专业术语、系统架构图与分层、模块与职责、数据流与存储、技术栈与平台能力、部署与构建形态、与设计文档及 CI/CD 的衔接。
...
- **阅读顺序**：建议先读 [00-System-Design](./00-System-Design.md)
  把握系统全貌，再按 01 → 02 → 03 → 04 → 05 理解各专项设计。
